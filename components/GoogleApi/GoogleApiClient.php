...
namespace app\components\GoogleApi;

use BadMethodCallException;
use DomainException;
use app\components\GoogleApi\AccessToken\Revoke;
use app\components\GoogleApi\AccessToken\Verify;
use app\components\GoogleApi\Auth\ApplicationDefaultCredentials;
use app\components\GoogleApi\Auth\Cache\MemoryCacheItemPool;
use app\components\GoogleApi\Auth\Credentials\ServiceAccountCredentials;
use app\components\GoogleApi\Auth\Credentials\UserRefreshCredentials;
use app\components\GoogleApi\Auth\CredentialsLoader;
use app\components\GoogleApi\Auth\FetchAuthTokenCache;
use app\components\GoogleApi\Auth\HttpHandler\HttpHandlerFactory;
use app\components\GoogleApi\Auth\OAuth2;
use app\components\GoogleApi\AuthHandler\AuthHandlerFactory;
use app\components\GoogleApi\Http\REST;
use app\components\GuzzleHttp\GuzzleClient;
use app\components\GuzzleHttp\ClientInterface;
use app\components\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use Monolog\Handler\StreamHandler as MonologStreamHandler;
use Monolog\Handler\SyslogHandler as MonologSyslogHandler;
use Monolog\Logger;
use app\components\Psr\Cache\CacheItemPoolInterface;
use app\components\Psr\Http\Message\RequestInterface;
use app\components\Psr\Http\Message\ResponseInterface;
use app\components\Psr\Log\LoggerInterface;
...
class GoogleApiClient
{
    ...
    {
        $guzzleVersion = null;
        if (defined('app\components\GuzzleHttp\ClientInterface::MAJOR_VERSION')) {
            $guzzleVersion = ClientInterface::MAJOR_VERSION;
        } elseif (defined('app\components\GuzzleHttp\ClientInterface::VERSION')) {

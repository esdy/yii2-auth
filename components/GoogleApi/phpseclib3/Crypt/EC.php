...
namespace app\components\GoogleApi\phpseclib3\Crypt;

use app\components\GoogleApi\phpseclib3\Crypt\Common\AsymmetricKey;
use app\components\GoogleApi\phpseclib3\Crypt\EC\BaseCurves\Base;
use app\components\GoogleApi\phpseclib3\Crypt\EC\BaseCurves\Montgomery as MontgomeryCurve;
use app\components\GoogleApi\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use app\components\GoogleApi\phpseclib3\Crypt\EC\Curves\Curve25519;
use app\components\GoogleApi\phpseclib3\Crypt\EC\Curves\Ed25519;
use app\components\GoogleApi\phpseclib3\Crypt\EC\Curves\Ed448;
use app\components\GoogleApi\phpseclib3\Crypt\EC\Formats\Keys\PKCS1;
use app\components\GoogleApi\phpseclib3\Crypt\EC\Parameters;
use app\components\GoogleApi\phpseclib3\Crypt\EC\PrivateKey;
use app\components\GoogleApi\phpseclib3\Crypt\EC\PublicKey;
use app\components\GoogleApi\phpseclib3\Exception\InvalidArgumentException;
use app\components\GoogleApi\phpseclib3\Exception\LengthException;
use app\components\GoogleApi\phpseclib3\Exception\UnsupportedAlgorithmException;
use app\components\GoogleApi\phpseclib3\Exception\UnsupportedCurveException;
use app\components\GoogleApi\phpseclib3\Exception\UnsupportedOperationException;
use app\components\GoogleApi\phpseclib3\File\ASN1;
use app\components\GoogleApi\phpseclib3\File\ASN1\Maps\ECParameters;
...
abstract class EC extends AsymmetricKey
{
    ...
    public static function createKey(string $curve): PrivateKey
    {
        ...
        $curve = '\app\components\GoogleApi\\phpseclib3\Crypt\EC\Curves\\' . $curveName;

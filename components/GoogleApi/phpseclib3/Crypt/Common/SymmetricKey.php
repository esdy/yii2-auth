...
namespace app\components\GoogleApi\phpseclib3\Crypt\Common;

use app\components\GoogleApi\phpseclib3\Common\Functions\Strings;
use app\components\GoogleApi\phpseclib3\Crypt\Blowfish;
use app\components\GoogleApi\phpseclib3\Crypt\Hash;
use app\components\GoogleApi\phpseclib3\Exception\BadDecryptionException;
use app\components\GoogleApi\phpseclib3\Exception\BadMethodCallException;
use app\components\GoogleApi\phpseclib3\Exception\BadModeException;
use app\components\GoogleApi\phpseclib3\Exception\InconsistentSetupException;
use app\components\GoogleApi\phpseclib3\Exception\InsufficientSetupException;
use app\components\GoogleApi\phpseclib3\Exception\LengthException;
use app\components\GoogleApi\phpseclib3\Exception\LogicException;
...
use app\components\GoogleApi\phpseclib3\Math\BinaryField;
use app\components\GoogleApi\phpseclib3\Math\PrimeField;

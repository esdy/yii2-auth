...
use app\components\GoogleApi\phpseclib3\Crypt\EC\BaseCurves\Binary as BinaryCurve;
use app\components\GoogleApi\phpseclib3\Crypt\EC\BaseCurves\Prime as PrimeCurve;
...
trait Common
{
    ...
    protected static function loadCurveByParam(array $params)
    {
        ...
        if (isset($params['namedCurve'])) {
            $curve = '\app\components\GoogleApi\phpseclib3\Crypt\EC\Curves\\' . $params['namedCurve'];
    ...
    private static function encodeParameters(BaseCurve $curve, bool $returnArray = false, array $options = [])
    {
        ...
        if ($useNamedCurves) {
            ...
            foreach (new \DirectoryIterator(__DIR__ . '/../../Curves/') as $file) {
                ...
                $class = 'app\components\GoogleApi\phpseclib3\Crypt\EC\Curves\\' . $testName;

...
namespace app\components\GoogleApi\phpseclib3\Math;
...
use app\components\GoogleApi\phpseclib3\Math\BigInteger\Engines\Engine;
...
class BigInteger implements \JsonSerializable
{
    ...
    public static function setEngine(string $main, array $modexps = ['DefaultEngine']): void
    {
        ...
        $fqmain = 'app\\components\\GoogleApi\\phpseclib3\\Math\\BigInteger\\Engines\\' . $main;
